...
public class Quest extends Console implements IQuestConsole{
    ...
    * Constructor
     ...
     * @param correct
    */
    public Quest(Adventure adventure, String name, String[] text, String[] question, String[] answer, int correct){
    ...
    * Constructor
     ...
     * @param correct
    */
    public Quest(Adventure adventure, String name, String[] text, String[] question, String[] answer, double correct){
        this.myAdventure = adventure;
        this.questName = name;
        this.text = text;
        this.question = question;
    ...
    * Constructor
     ...
     * @param correct
    */
    public Quest(Adventure adventure, String name, String[] text, String[] question, String[] answer, String[] correct){
        this.myAdventure = adventure;
        this.questName = name;
        this.text = text;
        this.question = question;

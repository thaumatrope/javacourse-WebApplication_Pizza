 ...
 */
public class QuestConsole extends Console {
    
    private String welcomeText;
    
    public QuestConsole (String text){
    ...
    public void printEndQuest(){ 
        ...
        System.out.println("(Zum Weiterspielen, bitte 'next' eingeben)");
        this.printDashes(60);
    }
    ...
    public void printEndQuestDEBUG(){ 
        ...
        System.out.println("(Zum Beenden des Programms, bitte 'exit' eingeben)");
        System.out.println("(Zum Hauptmenue zurückkehren, bitte 'menu' eingeben)");
        System.out.println("(Für einem weiteren Test, bitte 'test' eingeben)");
        this.printDashes(60);
    }

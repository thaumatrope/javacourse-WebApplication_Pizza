...
public class Datenbanken {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String verbindung="jdbc:mysql://178.6.48.73:3306/dezmber_e211?zeroDateTimeBehavior=convertToNull";
        //Treibermanager erstellt die Verbindung und leite sie an das Programm weier
        Connection myCon=DriverManager.getConnection(verbindung, "'root'", "");//Connextion ist Interface
        //Connecztion Objekt erstellt ein Statement Objekt und leitet es ans Programm weiter
        System.out.println("Connetction Objekt "+myCon);
        Statement mystm=myCon.createStatement();//Statement ist Interface
        //SQL String
        ...
        ResultSet meiRes=mystm.executeQuery(abfrage);//Resultset ist Interface
        ...
        meiRes.close();//Resultset
        mystm.close();//Statement
        myCon.close();//Verbindung zur Datenbank
